                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                <!--begin::Dropdown-->
                                <a href="{{ route('admin.category.create') }}" class="btn btn-warning font-weight-bolder font-size-sm mr-3">
                                    <i class="ki-duotone ki-add-folder"></i> Create New Category
                                </a>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-4 mb-5">
                                        ...
                                        <div class="card-xl-stretch me-md-6">
                                            ...
                                            <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                                href="{{ asset('uploads/categories') }}/{{ $category->icon }}" target="_blank">
                                                <!--begin::Image-->
                                            ...
                                            <div class="mt-2">
                                                <!--begin::Title-->
                                                <span href="{{ route('admin.category.edit', $category->id) }}"
                                                ...
                                                <div class="fs-6 fw-bold mt-2 d-flex flex-stack">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Action-->
                                                    <a href="{{ route('admin.category.edit', $category->id) }}" style="font-size: 15px"  class="btn btn-sm btn-primary">
