                        ...
                        <div class="container">
                            ...
                            <form action="{{ route('admin.order.edit', ['order_id' => $order->id]) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <table class="table table-bordered" id="skuTable">
                                        ...
                                        <tbody>
                                            @foreach($orderItems as $index => $orderItem)
                                                <tr>
                                                    <td>
                                                        <select name="skus[{{ $index }}][sku_id]" class="form-control">
                                                            <option value="" selected disabled>Select a SKU</option>
                                                            @foreach($skus as $sku)
                                                                <option value="{{ $sku->id }}" {{ $sku->id == $orderItem->product_id ? 'selected' : '' }}>{{ $sku->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <input type="number" name="skus[{{ $index }}][quantity]" class="form-control" min="1" value="{{ $orderItem->quantity }}">
                                                    </td>
                                                    <td>
                                    ...
                                    <button type="button" class="btn btn-success" onclick="addRow(this)">Add Row</button>
                                </div>
