            ...
            <div class="row">
                ...
                <div class="col-xxl-12 col-md-12 order-2 order-xxl-1">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <form class="form" action="{{ route('admin.sku.edit', $sku->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        <label>Name</label>
                                        <input type="text" class="form-control" name="name" placeholder="SKUs Name" value="{{ $sku->name }}" />
                                    </div>
                                    <div class="col-lg-6">
                                        <label>Description</label>
                                        <textarea rows="2" class="form-control" name="description" placeholder="SKUs Description">{!! $sku->description !!}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select id="category" name="category" class="form-control">
                                            ...
                                            @foreach($categories as $category)
                                                <option value="{{ $category->id }}" @if($category->id == old('category')) selected @endif>{{ $sku->category->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
