    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <a href="{{ route('admin.customer.index') }}" class="btn btn-warning font-weight-bolder font-size-sm mr-3">
                <i class="ki-duotone ki-add-folder"></i> View all Customers
            </a>
        </div>
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <form class="form" action="{{ route('admin.customer.create') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-2">
                                        <label>Country Code <span class="text-danger"><b>*</b></span> </label>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="number" class="form-control" name="phone" placeholder="Phone" value="{{ old('phone') }}" oninput="this.value = this.value.replace(/^0/g, '');" required/>
                                    </div>
                                    <div class="col-lg-3">
