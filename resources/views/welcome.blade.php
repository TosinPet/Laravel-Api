	...
	<nav class="navbar navbar-expand-xl navbar-light text-center py-3">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a class="btn btn-warning ms-2 ms-lg-3" href="{{ route('privacy') }}">Privacy Policy</a>
			</div>
		</div>
	</nav>
</header>
    ...
    <div class="row align-items-center justify-content-center">
      <div class="col-lg-6 mb-5 mb-lg-0">
        <div class="block text-center text-lg-start pe-0 pe-xl-5">
          <h2 class="text-capitalize mb-4">The Kirana initiative is to enable small store owners to expand their business, while allowing manufacturers to have direct access to retailers. </h2>
          <p class="mb-4">Sanda Tireda leverages technology through a customized software application which enables the Kirana customers from orders to delivery and ultimate sales to consumers.  </p> 
            {{-- <a type="button" class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#applyLoan">Apply Loan Now <span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a> --}}
        </div>
      </div>
      <div class="col-lg-6">
        <div class="ps-lg-5 text-center">
          <img loading="lazy" decoding="async"
            src="{{ asset('asset/images/banner/banner.png') }}"
